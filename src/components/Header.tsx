      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-brand-tertiary">
            <Link to="/" className="text-brand-quaternary hover:text-brand-primary transition-colors">Home</Link>
            <Link to="/coleções" className="text-brand-quaternary hover:text-brand-primary transition-colors">Coleções</Link>
            <Link to="/sobre" className="text-brand-quaternary hover:text-brand-primary transition-colors">Sobre</Link>
            <Link to="/contato" className="text-brand-quaternary hover:text-brand-primary transition-colors">Contato</Link>
          </nav>
        </div>
