  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-brand-septenary">
      ...
      <div className="max-w-7xl mx-auto">
        <Link to={`/coleção/${collection?.slug}`} className="text-sm md:text-base text-brand-secondary hover:underline mb-24 flex items-center uppercase tracking-wider md:tracking-widest">
          <ArrowLeft className="inline-block mr-1" />{collection?.slug}
        </Link>
